 ...
 **************************************************************************/
#ifdef KERNEL
inline int RecvIt(xi_socket_t sock, char *buf, int size );
inline int SendIt(xi_socket_t sock, char *buf, int size );
#else 	/* if KERNEL */
...
#ifdef KERNEL
inline int RecvIt(xi_socket_t sock_ptr, char *buf, int size )
#else 	/* if KERNEL */
inline int RecvIt(int sock, char *buf, int size )
#endif 	/* if KERNEL else */
{
...
#ifdef KERNEL
inline int SendIt(xi_socket_t sock_ptr, char *buf, int size )
#else 	/* if KERNEL */
inline int SendIt(int sock, char *buf, int size )
#endif 	/* if KERNEL else */
{
