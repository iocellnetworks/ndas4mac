...
#else
#define IS_DIB_DATA_CRC_VALID(CRC_FUNC, DIB) ((DIB).crc32 == NDASSwap32LittleToHost(CRC_FUNC((unsigned char *)&(DIB), sizeof((DIB).bytes_248))))
#define IS_DIB_UNIT_CRC_VALID(CRC_FUNC, DIB) ((DIB).crc32_unitdisks == NDASSwap32LittleToHost(CRC_FUNC((unsigned char *)&(DIB).UnitDisks, sizeof((DIB).UnitDisks))))
#endif

#define IS_DIB_CRC_VALID(CRC_FUNC, DIB) (IS_DIB_DATA_CRC_VALID(CRC_FUNC, DIB) && IS_DIB_UNIT_CRC_VALID(CRC_FUNC, DIB))

#define SET_DIB_DATA_CRC(CRC_FUNC, DIB) ((DIB).crc32 = NDASSwap32HostToLittle(CRC_FUNC((unsigned char *)&(DIB), sizeof((DIB).bytes_248))))
#define SET_DIB_UNIT_CRC(CRC_FUNC, DIB) ((DIB).crc32_unitdisks = NDASSwap32HostToLittle(CRC_FUNC((unsigned char *)&(DIB).UnitDisks, sizeof((DIB).UnitDisks))))
...
#else
#define IS_RMD_DATA_CRC_VALID(CRC_FUNC, RMD) ((RMD).crc32 == NDASSwap32LittleToHost(CRC_FUNC((unsigned char *)&(RMD), sizeof((RMD).bytes_248))))
#define IS_RMD_UNIT_CRC_VALID(CRC_FUNC, RMD) ((RMD).crc32_unitdisks == NDASSwap32LittleToHost(CRC_FUNC((unsigned char *)&(RMD).UnitMetaData, sizeof((RMD).UnitMetaData))))
#endif

#define IS_RMD_CRC_VALID(CRC_FUNC, RMD) (IS_RMD_DATA_CRC_VALID(CRC_FUNC, RMD) && IS_RMD_UNIT_CRC_VALID(CRC_FUNC, RMD))

#define SET_RMD_DATA_CRC(CRC_FUNC, RMD) ((RMD).crc32 = NDASSwap32HostToLittle(CRC_FUNC((unsigned char *)&(RMD), sizeof((RMD).bytes_248))))
#define SET_RMD_UNIT_CRC(CRC_FUNC, RMD) ((RMD).crc32_unitdisks = NDASSwap32HostToLittle(CRC_FUNC((unsigned char *)&(RMD).UnitMetaData, sizeof((RMD).UnitMetaData))))
