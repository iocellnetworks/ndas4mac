...
protected:
	...
	static IOReturn sRegisterKey(NDASFamilyUserClientClassName* target, void* reference, IOExternalMethodArguments* arguments);
	...
	virtual IOReturn RegisterKey(PNDAS_ENUM_REGISTER_KEY	registerKeyData,
								 uint32_t					*result,
								 IOByteCount				inStructSize,
								 IOByteCount				*outStructSize);	
