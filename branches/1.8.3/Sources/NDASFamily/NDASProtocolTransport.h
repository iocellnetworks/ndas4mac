...
#if USE_ELG /* (( */
#define ELG(A,B,ASCI,STRING)    EvLog( (uint32_t)(A), (uint32_t)(B), (uint32_t)(ASCI), STRING )
#define PAUSE(A,B,ASCI,STRING)  Pause( (uint32_t)(A), (uint32_t)(B), (uint32_t)(ASCI), STRING )
#else /* ) not USE_ELG: (   */
