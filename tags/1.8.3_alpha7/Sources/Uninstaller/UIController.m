...
@"/Library/StartupItems/XiMetaNetLpx",			// NETLPX_START1_8_3
...
@"/Library/StartupItems/XiMetaNDASService",			// NDASSERVICE_START1_8_3
@"/Library/LaunchDaemons/com.ximeta.NDASService.plist",	// NDASSERVICE_LAUNCH_DAEMON1_8_3
...
//			NSLog(@"[%d] %@\n", i + ComponnentsToRemove, PropertyPath[i]);
	...
	[InfoTextField setStringValue: [NSString localizedStringWithFormat: 
							  NSLocalizedString(@"The %@ software was sucessfully uninstalled. You must restsart your computer now.", @"Uninstall success"),
							  tempString]];
	[InfoTextField displayIfNeeded];

	bUninstallEnd = YES;
	
	[QuitButton setTitle: NSLocalizedString(@"Restart", @"Restart Button")];
